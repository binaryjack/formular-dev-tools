# Contributing to formular-dev-tools
...
# Build this package
pnpm --filter @formular/dev-tools build

# Run tests
pnpm --filter @formular/dev-tools test

# Watch mode
pnpm --filter @formular/dev-tools dev
```
...
```bash
pnpm --filter @formular/dev-tools test
pnpm --filter @formular/dev-tools typecheck
pnpm --filter @formular/dev-tools lint
```
